...
| `check_docs_relative_links.py` | Fail on relative links in `docs/**/*.md` whose target file is missing (catches `.ipynb`/asset links Zensical does not check) | Docs CI / after re-rendering the tutorial notebooks |
