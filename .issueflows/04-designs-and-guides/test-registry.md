...
| tests/test_collected_summary_groups.py::test_summary_collector_spread_plot_keeps_custom_group_labels | yes | yes | summary_collector.plot spread + custom_group_labels | #948 | issue snippet; Collection-only test was not enough |
