...
PIP_DEVELOPMENT_MODE = (
    "pip install -e ."
)  # will install in development mode for current virtualenv
...
FIND_CELLPY_VERSION_ON_PYPI = (
    "yolk -V cellpy"
)  # First you might have to install yolk: pip install yolk3k
...
CONVERT_CONDA_BUILDS = (
    "conda convert --platform all PATH"
)  # convert to different platforms
