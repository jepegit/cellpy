...
batmo_file_name = "batmo_bdf.csv"
batmo_file_path = os.path.join(raw_data_dir, batmo_file_name)
...
# ---------- deliberately-broken fixtures (#655) -----
# Generated by dev/make_bad_fixtures.py from custom_data_001.csv; each isolates
# one defect. See tests/test_bad_fixtures.py for the pinned behavior contract.
bad_dir = os.path.join(data_dir, "bad")
bad_custom_instrument_path = custom_instrument_definitions_file  # custom_instrument_001.yml
bad_good_small_path = os.path.join(bad_dir, "custom_good_small.csv")
bad_nan_inf_path = os.path.join(bad_dir, "custom_nan_inf.csv")
bad_missing_cycle_path = os.path.join(bad_dir, "custom_missing_cycle.csv")
bad_truncated_path = os.path.join(bad_dir, "custom_truncated.csv")
bad_missing_column_path = os.path.join(bad_dir, "custom_missing_column.csv")
