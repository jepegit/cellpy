...
class cellpydata(object):
    ...
    def _make_summary(self,
        ...
        date_time_txt_title = self.summary_txt_datetime_txt
        ...
        high_level_at_cycle_n_txt = self.summary_txt_high_level
        low_level_at_cycle_n_txt = self.summary_txt_low_level
