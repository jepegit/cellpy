...
normal_headers_renaming_dict = {
    ...
    "cycle_index_txt": f"Cycle_ID",
    "step_index_txt": f"Step_ID",
    ...
    "power_txt": f"Power({unit_labels['power']})",
    ...
    "dv_dt_txt": f"dV/dt({incremental_unit_labels['resistance']})",
    "acr_txt": f"Internal_Resistance({unit_labels['resistance']})",  # new not implemented
    ...
    "frequency_txt": f"Frequency({unit_labels['resistance']})",  # new
...
normal_headers_renaming_dict_old = {
    "aci_phase_angle_txt": f"ACI_Phase_Angle",
    "ref_aci_phase_angle_txt": f"Reference_ACI_Phase_Angle",
    "ac_impedance_txt": f"AC_Impedance({unit_labels['resistance']})",
    "ref_ac_impedance_txt": f"Reference_AC_Impedance",
    "charge_capacity_txt": f"Charge_Capacity({unit_labels['resistance']})",
    "charge_energy_txt": f"Charge_Energy({unit_labels['resistance']})",
    "current_txt": f"Current({unit_labels['resistance']})",
    "cycle_index_txt": f"Cycle_ID",
    "data_point_txt": f"Data_Point",
    "datetime_txt": f"Date_Time",
    "discharge_capacity_txt": f"Discharge_Capacity({unit_labels['resistance']})",
    "discharge_energy_txt": f"Discharge_Energy({unit_labels['resistance']})",
    "internal_resistance_txt": f"Internal_Resistance({unit_labels['resistance']})",
    "is_fc_data_txt": f"Is_FC_Data",
    "step_index_txt": f"Step_ID",
    "sub_step_index_txt": f"Sub_Step_Index",  # new
    "step_time_txt": f"Step_Time",
    "sub_step_time_txt": f"Sub_Step_Time",  # new
    "test_id_txt": f"Test_ID",
    "test_time_txt": f"Test_Time({unit_labels['resistance']})",
    "voltage_txt": f"Voltage({unit_labels['resistance']})",
    "ref_voltage_txt": f"Reference_Voltage({unit_labels['resistance']})",  # new
    "dv_dt_txt": f"dV/dt({incremental_unit_labels['resistance']})",
    "frequency_txt": f"Frequency({unit_labels['resistance']})",  # new
    "amplitude_txt": f"Amplitude",  # new
