...
_standard_template_uri = "https://github.com/jepegit/cellpy_cookie_dev.git"  # v.0.5 remove this
_registered_templates = {
    "standard": ("https://github.com/jepegit/cellpy_cookie_standard.git", ""),  # v.0.5 remove this
    "ife": ("https://github.com/jepegit/cellpy_cookie_ife.git", ""),  # v.0.5 remove this
    "dev": ("https://github.com/jepegit/cellpy_cookie_dev.git", "standard"),  # v.0.5 remove this
