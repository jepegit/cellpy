...
class CellpyCell:
    ...
    # def nom_cap_specifics(self, c):
    #     # if c.lower() == "areal":
    #     #     nominal_capacity = f"{self.cellpy_units.charge}/{self.cellpy_units.specific_areal}"
    #     # elif c.lower() == "gravimetric":
    #     #     nominal_capacity = f"{self.cellpy_units.charge}/{self.cellpy_units.specific_gravimetric}"
    #     # elif c.lower() == "volumetric":
    #     #     nominal_capacity = f"{self.cellpy_units.charge}/{self.cellpy_units.specific_volumetric}"
    #     # elif c.lower() == "absolute":
    #     #     nominal_capacity = f"{self.cellpy_units.charge}"
    #     # else:
    #     #     logging.warning(f"Unknown nominal capacity specific: {c}")
    #     #     return
    #     if nominal_capacity := self._nom_cap_specifics(c):
    #         self.cellpy_units.nom_cap_specifics = nominal_capacity
    #         self.data.meta_common.nom_cap_specifics = c.lower()

    def _nom_cap_specifics(self, c):
        if c.lower() == "areal":
            nominal_capacity = f"{self.cellpy_units.charge}/{self.cellpy_units.specific_areal}"
        elif c.lower() == "gravimetric":
            nominal_capacity = f"{self.cellpy_units.charge}/{self.cellpy_units.specific_gravimetric}"
    ...
    def get_cycle_numbers(
        ...
        # return self.core.get_cycle_numbers(
        #     steptable=steptable,
        #     rate=rate,
        #     rate_on=rate_on,
        #     rate_std=rate_std,
    ...
    def _make_summary2(
        ...
        **kwargs,
        ...
        # # TODO @jepe: refactor this to method:
        # if find_end_voltage:
        #     data = self.core._end_voltage_to_summary(data)
